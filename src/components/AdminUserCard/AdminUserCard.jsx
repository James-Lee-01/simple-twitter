    ...
    <div className={styles.mainContainer} id={key}>
      ...
      <div className={styles.infoContainer}>
        ...
        <div className={styles.iconContainer}>
          ...
          <div className={styles.count}>{tweetCount || 0}</div>
          <img className={styles.icon} src={admin_like} alt='like' />
          <div className={styles.count}>{likeCount || 0}</div>
        </div>

        <div className={styles.followContainer}>

          <div className={styles.followNum}>{followingNum || 0}</div>
          <div className={styles.followType}>跟隨中</div>

          <div className={styles.followNum}>{followerNum || 0}</div>
